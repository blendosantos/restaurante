    ...
    <div class="container">
        ...
        <div class="col-xs-12">
            <div class="pull-right mg-bottom">
                <a class="btn btn-cadastro btn-sm" href="/servico/cadastro" role="button">Novo</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Consultar Serviço</h4>
                </div>
    ...
    function paginar() {
        ...
        for (var i = pagina * tamanhoPagina; i < dados.length && i < (pagina + 1) * tamanhoPagina; i++) {
            tbody.append(
                    ...
                    .append($('<td>').append(dados[i].servico))
                    .append($('<td>').append(dados[i].dsServico))
                    .append($('<td>').append('R$ ' + formatReal(dados[i].vlServico)))
                    .append($('<td>')
